        ...
        <div class="Wrap relative w-full overflow-x-auto">
          <table class="Table w-full table-fixed">
            ...
            <tbody class="TableBody relative w-full">
              ...
              >
                <td class="w-[180px] py-6 px-2 text-left capitalize text-netral-80 first:pl-3">
                  <Body size="lg" weight="medium">
                    {{ product.transactionNumber }}
                  </Body>
                </td>

                <td class="w-[140px] py-6 px-2 text-left capitalize text-netral-80 first:pl-3">
                  <Body size="lg" weight="medium">
                    {{ product.customerName }}
                  </Body>
                </td>

                <td class="w-[170px] py-6 px-2 text-left capitalize text-netral-80 first:pl-3">
                  <Body size="lg" weight="medium">
                    {{ product.purchasedProduct }}
                  </Body>
                </td>

                <td class="w-[120px] py-6 px-2 text-left capitalize text-netral-80 first:pl-3">
                  <Body size="lg" weight="medium">
                    {{ product.date }}
                  </Body>
                </td>
                ...
                <td class="w-[80px] py-6 px-2 text-left capitalize text-netral-80 first:pl-3">
                  <Body size="lg" weight="medium">
                ...
                <td class="w-[60px] py-6 px-2 text-left capitalize text-netral-80 first:pl-3">
                  <button
                    class="text-primary-main"
                    @click="$router.push('/transactions/manage-returns/approve')"
                  >
